          ...
          'Core Software & Development' => [
            ...
            'Internet of Things (IoT)' => [
                ...
                'subs' => [
                    ...
                    ['en' => 'Introduction to IoT', 'ku' => 'پێشەکی بۆ ئینتەرنێتی شتان'],
            ['en' => 'IoT Fundamentals', 'ku' => 'بنەماکانی ئینتەرنێتی شتان'],
            ['en' => 'IoT Architecture', 'ku' => 'تەلارسازی ئینتەرنێتی شتان'],
            ['en' => 'IoT Devices & Sensors', 'ku' => 'ئامێر و سەنسۆرەکانی ئینتەرنێتی شتان'],
            ['en' => 'IoT Protocols & Communication','ku' => 'پرۆتۆکۆل و پەیوەندیکردنی ئینتەرنێتی شتان'],
            ['en' => 'IoT Data Management', 'ku' => 'بەڕێوەبردنی داتای ئینتەرنێتی شتان'],
            ['en' => 'IoT Security & Privacy', 'ku' => 'ئاسایش و تایبەتمەندی ئینتەرنێتی شتان'],
            ['en' => 'Smart Home Systems', 'ku' => 'سیستەمی ماڵی زیرەک'],
            ['en' => 'Wearable Technology', 'ku' => 'تەکنەلۆژیای بەرپێچراو'],
            ['en' => 'Connected Appliances', 'ku' => 'ئامێرە بەستراوەکان'],
            ['en' => 'Industrial IoT (IIoT)', 'ku' => 'ئینتەرنێتی شتانی پیشەسازی'],
            ['en' => 'Smart Manufacturing', 'ku' => 'بەرهەمهێنانی زیرەک'],
            ['en' => 'IoT in Agriculture', 'ku' => 'ئینتەرنێتی شتان لە کشتوکاڵ'],
            ['en' => 'IoT in Healthcare', 'ku' => 'ئینتەرنێتی شتان لە تەندروستی'],
            ['en' => 'IoT in Transportation', 'ku' => 'ئینتەرنێتی شتان لە گواستنەوە'],
            ['en' => 'Smart Cities', 'ku' => 'شارە زیرەکەکان'],
            ['en' => 'Environmental Monitoring', 'ku' => 'چاودێری ژینگەیی'],
            ['en' => 'Smart Energy & Grid', 'ku' => 'وزە و تۆڕی زیرەک'],
            ['en' => 'Edge Computing for IoT', 'ku' => 'کۆمپیوتەری لێواری بۆ ئینتەرنێتی شتان'],
            ['en' => 'AI & Machine Learning in IoT', 'ku' => 'زیرەکی دەست‌کرد و فێرکاری ماشین لە ئینتەرنێتی شتان'],
            ['en' => 'IoT Analytics & Big Data', 'ku' => 'شیکردنەوە و داتای گەورەی ئینتەرنێتی شتان'],
            ['en' => 'IoT Development Platforms', 'ku' => 'پلاتفۆرمەکانی گەشەپێدانی ئینتەرنێتی شتان'],
            ['en' => 'IoT Project Management', 'ku' => 'بەڕێوەبردنی پرۆژەی ئینتەرنێتی شتان'],
        ],
            ],
